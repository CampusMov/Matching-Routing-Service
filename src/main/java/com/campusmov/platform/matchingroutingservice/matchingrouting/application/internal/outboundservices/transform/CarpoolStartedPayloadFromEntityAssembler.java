...
public class CarpoolStartedPayloadFromEntityAssembler {
    public static CarpoolStartedPayload fromEntity(Carpool entity) {
        return CarpoolStartedPayload.builder().
                id(entity.getId()).
