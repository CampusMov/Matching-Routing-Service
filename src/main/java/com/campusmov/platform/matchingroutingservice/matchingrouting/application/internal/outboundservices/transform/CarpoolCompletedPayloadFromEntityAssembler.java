...
public class CarpoolCompletedPayloadFromEntityAssembler {
    public static CarpoolCompletedPayload fromEntity(Carpool entity) {
        return CarpoolCompletedPayload.builder().
                id(entity.getId()).
